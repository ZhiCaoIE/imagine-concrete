...
def cement_carbonation(
    ...
    for i in range(0,1000):
        random.seed(a=i);coefC15_random.append(random.uniform(a = 13.9, b = 6.1))
        random.seed(a=i);coefC16_random.append(random.uniform(a = 9.8, b = 3.9))
        random.seed(a=i);coefC23_random.append(random.uniform(a = 7, b = 2.4))
        random.seed(a=i);coefC35_random.append(random.uniform(a = 4, b = 1.3))
    ...
    coefC15B = 1.9 * impact_factor * (1+Mine_coef_increase)
    coefC16B = 1   * impact_factor * (1+Mine_coef_increase)
    coefC23B = 0.7 * impact_factor * (1+Mine_coef_increase)
    coefC35B = 0.3 * impact_factor * (1+Mine_coef_increase)
    ...
    for i in range(0,1000):
        random.seed(a=i);C15percentage_random.append(random.weibullvariate(alpha = 0.734, beta = 13)*
        random.weibullvariate(alpha = 0.165, beta = 3.5))
        random.seed(a=i);C16percentage_random.append(random.weibullvariate(alpha = 0.734, beta = 13)*
        random.weibullvariate(alpha = 0.137, beta = 3))
        random.seed(a=i);C23percentage_random.append(random.weibullvariate(alpha = 0.734, beta = 13)*
        random.weibullvariate(alpha = 0.66, beta = 7))
        random.seed(a=i);C35percentage_random.append(random.weibullvariate(alpha = 0.734, beta = 13)*
        random.weibullvariate(alpha = 0.116, beta = 3.5))
    ...
    for i in range(0,1000):
        random.seed(a=i);RENpercentage_random.append((1-random.weibullvariate(alpha = 0.734, beta = 13))*
        random.weibullvariate(alpha = 0.524, beta = 14))
        random.seed(a=i);MASpercentage_random.append((1-random.weibullvariate(alpha = 0.734, beta = 13))*
        random.weibullvariate(alpha = 0.188, beta = 12))
        random.seed(a=i);MAIpercentage_random.append((1-random.weibullvariate(alpha = 0.734, beta = 13))*
        random.weibullvariate(alpha = 0.332, beta = 10))
    ...
    for i in range(0,1000):
        random.seed(a=i);radiusRec_random.append(
            random.uniform(a = 0.021, b= 0.2)*2.5+random.uniform(a = 0.175, b= 0.412)*3.75+
            random.uniform(a = 0.32, b= 0.45)*7.5+random.uniform(a = 0.1, b= 0.267)*15)

        random.seed(a=i);radiusBur_random.append((
            (random.uniform(a = 0.051, b= 0.2)*0.5+random.uniform(a = 0.2, b= 0.367)*2.75+
            random.uniform(a = 0.356, b= 0.6)*10+random.uniform(a = 0, b= 0.28)*20.75)*0.023+

            (random.uniform(a = 0.122, b= 0.256)*5+random.uniform(a = 0.195, b= 0.354)*10+
            random.uniform(a = 0.106, b= 0.225)*20+random.uniform(a = 0.248, b= 0.484)*25)*0.9769+

            (random.uniform(a = 0.021, b= 0.2)*2.5+random.uniform(a = 0.175, b= 0.412)*3.75+
            random.uniform(a = 0.32, b= 0.45)*7.5+random.uniform(a = 0.1, b= 0.267)*15)*0)/
            (0.023 + 0.9769 + 0)
        )

        random.seed(a=i);radiusRecA_random.append(
            random.uniform(a = 0.021, b= 0.2)*2.5+random.uniform(a = 0.175, b= 0.412)*2.5+
            random.uniform(a = 0.32, b= 0.45)*5+random.uniform(a = 0.1, b= 0.267)*10)
        
        random.seed(a=i);radiusRecB_random.append(
            random.uniform(a = 0.021, b= 0.2)*2.5+random.uniform(a = 0.175, b= 0.412)*5+
            random.uniform(a = 0.32, b= 0.45)*10+random.uniform(a = 0.1, b= 0.267)*20)

        random.seed(a=i);radiusBurA_random.append((
            (random.uniform(a = 0.051, b= 0.2)*0.5+
            random.uniform(a = 0.2, b= 0.367)*0.5+
            random.uniform(a = 0.356, b= 0.6)*5+
            random.uniform(a = 0, b= 0.28)*15)*0.023+

            (random.uniform(a = 0.122, b= 0.256)*5+
            random.uniform(a = 0.195, b= 0.354)*5+
            random.uniform(a = 0.106, b= 0.225)*15+
            random.uniform(a = 0.248, b= 0.484)*25)*0.9769+

            (random.uniform(a = 0.021, b= 0.2)*2.5+
            random.uniform(a = 0.175, b= 0.412)*2.5+
            random.uniform(a = 0.32, b= 0.45)*5+
            random.uniform(a = 0.1, b= 0.267)*10)*0)/
            (0.023 + 0.9769 + 0)
        )

        random.seed(a=i);radiusBurB_random.append((
            (random.uniform(a = 0.051, b= 0.2)*0.5+
            random.uniform(a = 0.2, b= 0.367)*5+
            random.uniform(a = 0.356, b= 0.6)*15+
            random.uniform(a = 0, b= 0.28)*26.5)*0.023+
            ...
            (random.uniform(a = 0.021, b= 0.2)*2.5+
            random.uniform(a = 0.175, b= 0.412)*5+
            random.uniform(a = 0.32, b= 0.45)*10+
            random.uniform(a = 0.1, b= 0.267)*20)*0)/
            (0.023 + 0.9769 + 0)
        )
    ...
    for i in range(0,1000):
        ...
        random.seed(a=i);CONpercentage_random.append(random.weibullvariate(alpha = 0.734, beta = 13))
