...
for storyline in storylines:
    ...
    for scenario_index in lever_list_story:
        ...
        #unit: km
        Use_km_Mot = data_inputs.iloc[86:130,16]
        Use_km_Hig = data_inputs.iloc[86:130,17]
        Use_km_Sec = data_inputs.iloc[86:130,18]
        Use_km_Oth = data_inputs.iloc[86:130,19]
        ...
        #clinker is also used in the carbonation module; 2001-2060
        ...
        pd.DataFrame(new_km_extended_matrix).to_excel(
            r'C:\Users\caozh\Documents\2020-ClimateWork\Carbonation\India-Roads' + \
