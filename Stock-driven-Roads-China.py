...
for storyline in storylines:
    ...
    for scenario_index in lever_list_story:
        ...
        ##################new road length####################################
        #unit: km;
        new_km_Mot_Unp = data_inputs.iloc[0:87,0]
        new_km_Mot_Bit = data_inputs.iloc[0:87,1]
        new_km_Mot_Con = data_inputs.iloc[0:87,2]
        new_km_Mot_Com = data_inputs.iloc[0:87,3]

        new_km_Hig_Unp = data_inputs.iloc[0:87,4]
        new_km_Hig_Bit = data_inputs.iloc[0:87,5]
        new_km_Hig_Con = data_inputs.iloc[0:87,6]
        new_km_Hig_Com = data_inputs.iloc[0:87,7]

        new_km_Sec_Unp = data_inputs.iloc[0:87,8]
        new_km_Sec_Bit = data_inputs.iloc[0:87,9]
        new_km_Sec_Con = data_inputs.iloc[0:87,10]
        new_km_Sec_Com = data_inputs.iloc[0:87,11]

        new_km_Oth_Unp = data_inputs.iloc[0:87,12]
        new_km_Oth_Bit = data_inputs.iloc[0:87,13]
        new_km_Oth_Con = data_inputs.iloc[0:87,14]
        new_km_Oth_Com = data_inputs.iloc[0:87,15]

        ##################Scenario parameters 2017-2060#########################################
        #unit: km
        Use_km_Mot = data_inputs.iloc[86:130,16] * 10000
        Use_km_Hig = data_inputs.iloc[86:130,17] * 10000
        Use_km_Sec = data_inputs.iloc[86:130,18] * 10000
        Use_km_Oth = data_inputs.iloc[86:130,19] * 10000

        #Motorways
        Mot_Unp = data_inputs.iloc[86:130,20]
        Mot_Bit = data_inputs.iloc[86:130,21]
        Mot_Con = data_inputs.iloc[86:130,22]
        Mot_Com = data_inputs.iloc[86:130,23]

        #Highways
        Hig_Unp = data_inputs.iloc[86:130,24]
        Hig_Bit = data_inputs.iloc[86:130,25]
        Hig_Con = data_inputs.iloc[86:130,26]
        Hig_Com = data_inputs.iloc[86:130,27]

        #Secondary
        Sec_Unp = data_inputs.iloc[86:130,28]
        Sec_Bit = data_inputs.iloc[86:130,29]
        Sec_Con = data_inputs.iloc[86:130,30]
        Sec_Com = data_inputs.iloc[86:130,31]

        #Other roads
        Oth_Unp = data_inputs.iloc[86:130,32]
        Oth_Bit = data_inputs.iloc[86:130,33]
        Oth_Con = data_inputs.iloc[86:130,34]
        Oth_Com = data_inputs.iloc[86:130,35]
        ...
        Pro_Em_factor = data_inputs.iloc[87:130,87]

        #MJ/t clinker
        Them_eff = data_inputs.iloc[87:130,88]

        Coal_share_cem = data_inputs.iloc[87:130,89]
        Oil_share_cem  = data_inputs.iloc[87:130,90]
        NaGa_share_cem = data_inputs.iloc[87:130,91]
        WaFu_share_cem = data_inputs.iloc[87:130,92]
        Biom_share_cem = data_inputs.iloc[87:130,93]

        Coal_CO2_cem = data_inputs.iloc[87:130,94]
        Oil_CO2_cem  = data_inputs.iloc[87:130,95]
        NaGa_CO2_cem = data_inputs.iloc[87:130,96]
        WaFu_CO2_cem = data_inputs.iloc[87:130,97]
        Biom_CO2_cem = data_inputs.iloc[87:130,98]

        #clinker is also used in the carbonation module; 1931-2060
        clinker = data_inputs.iloc[:,99]

        Gyp_share = data_inputs.iloc[87:130,100]
        Lim_share = data_inputs.iloc[87:130,101]
        Poz_share = data_inputs.iloc[87:130,102]
        Sla_share = data_inputs.iloc[87:130,103]
        Fly_share = data_inputs.iloc[87:130,104]
        Cla_share = data_inputs.iloc[87:130,105]
        Ene_Cla   = data_inputs.iloc[87:130,106]

        CCS_Oxy_percent = data_inputs.iloc[87:130,107]
        CCS_Pos_percent = data_inputs.iloc[87:130,108]
        Eff_Oxy = data_inputs.iloc[87:130,109]
        Eff_Pos = data_inputs.iloc[87:130,110]
        Ene_Oxy = data_inputs.iloc[87:130,111]
        Ene_Pos = data_inputs.iloc[87:130,112]

        Ele_eff        = data_inputs.iloc[87:130,113]
        Coal_share_ele = data_inputs.iloc[87:130,114]
        Oil_share_ele  = data_inputs.iloc[87:130,115]
        Naga_share_ele = data_inputs.iloc[87:130,116]
        Hydr_share_ele = data_inputs.iloc[87:130,117]
        Geot_share_ele = data_inputs.iloc[87:130,118]
        Sol_share_ele  = data_inputs.iloc[87:130,119]
        Wind_share_ele = data_inputs.iloc[87:130,120]
        Tide_share_ele = data_inputs.iloc[87:130,121]
        Nuc_share_ele  = data_inputs.iloc[87:130,122]
        Bio_share_ele  = data_inputs.iloc[87:130,123]
        Was_share_ele  = data_inputs.iloc[87:130,124]
        SoTh_share_ele = data_inputs.iloc[87:130,125]

        Coal_CO2_ele = data_inputs.iloc[87:130,126]
        Oil_CO2_ele  = data_inputs.iloc[87:130,127]
        Naga_CO2_ele = data_inputs.iloc[87:130,128]
        Hydr_CO2_ele = data_inputs.iloc[87:130,129]
        Geot_CO2_ele = data_inputs.iloc[87:130,130]
        Sol_CO2_ele  = data_inputs.iloc[87:130,131]
        Wind_CO2_ele = data_inputs.iloc[87:130,132]
        Tide_CO2_ele = data_inputs.iloc[87:130,133]
        Nuc_CO2_ele  = data_inputs.iloc[87:130,134]
        Bio_CO2_ele  = data_inputs.iloc[87:130,135]
        Was_CO2_ele  = data_inputs.iloc[87:130,136]
        SoTh_CO2_ele = data_inputs.iloc[87:130,137]
        ...
        int_Tim_matrix = pd.concat([int_Con_Mot_Unp*(1-Leaner_con_saving)*Mat_sub_rate*(1-waste_saving*0.015)*Timber_to_cem,\
                                    int_Con_Mot_Bit*(1-Leaner_con_saving)*Mat_sub_rate*(1-waste_saving*0.015)*Timber_to_cem,\
                                    int_Con_Mot_Con*(1-Leaner_con_saving)*Mat_sub_rate*(1-waste_saving*0.015)*Timber_to_cem,\
                                    int_Con_Mot_Com*(1-Leaner_con_saving)*Mat_sub_rate*(1-waste_saving*0.015)*Timber_to_cem,\
                                    int_Con_Hig_Unp*(1-Leaner_con_saving)*Mat_sub_rate*(1-waste_saving*0.015)*Timber_to_cem,\
                                    int_Con_Hig_Bit*(1-Leaner_con_saving)*Mat_sub_rate*(1-waste_saving*0.015)*Timber_to_cem,\
                                    int_Con_Hig_Con*(1-Leaner_con_saving)*Mat_sub_rate*(1-waste_saving*0.015)*Timber_to_cem,\
                                    int_Con_Hig_Com*(1-Leaner_con_saving)*Mat_sub_rate*(1-waste_saving*0.015)*Timber_to_cem,\
                                    int_Con_Sec_Unp*(1-Leaner_con_saving)*Mat_sub_rate*(1-waste_saving*0.015)*Timber_to_cem,\
                                    int_Con_Sec_Bit*(1-Leaner_con_saving)*Mat_sub_rate*(1-waste_saving*0.015)*Timber_to_cem,\
                                    int_Con_Sec_Con*(1-Leaner_con_saving)*Mat_sub_rate*(1-waste_saving*0.015)*Timber_to_cem,\
                                    int_Con_Sec_Com*(1-Leaner_con_saving)*Mat_sub_rate*(1-waste_saving*0.015)*Timber_to_cem,\
                                    int_Con_Oth_Unp*(1-Leaner_con_saving)*Mat_sub_rate*(1-waste_saving*0.015)*Timber_to_cem,\
                                    int_Con_Oth_Bit*(1-Leaner_con_saving)*Mat_sub_rate*(1-waste_saving*0.015)*Timber_to_cem,\
                                    int_Con_Oth_Con*(1-Leaner_con_saving)*Mat_sub_rate*(1-waste_saving*0.015)*Timber_to_cem,\
                                    int_Con_Oth_Com*(1-Leaner_con_saving)*Mat_sub_rate*(1-waste_saving*0.015)*Timber_to_cem], axis = 1)
        ...
        for i in range(0, len(new_km_matrix.columns)):
            ...
            for k in range(2018, 2061):
                ...
                reuse_Con_list    = demolish_km_list * int_Con * reuse_rate
        ...
        pd.DataFrame(new_km_extended_matrix).to_excel(
            r'C:\Users\caozh\Documents\2020-ClimateWork\Carbonation\China-Roads' + \
        ...
        EoL_tim_land = pd.Series(np.zeros(130)),
        Land_tim_deg = pd.Series(np.zeros(130)),
        Deg_tim_CH4 = pd.Series(np.zeros(130)),
        Deg_tim_CO2 = pd.Series(np.zeros(130)),
        CH4_to_CO2 = pd.Series(np.zeros(130)),
        CH4_recover = pd.Series(np.zeros(130)),
        EoL_tim_inci = pd.Series(np.zeros(130)),
        scenario_index = scenario_index,
        storyline = storyline,
        filepath = 'China-Roads'
        )

        import Carbonation_China

        Carbonation_China.cement_carbonation(
        year_len = 130,
        index_year2018 = 87,
        Belite_share = Belite_share,
