...
def cement_carbonation(
    ...
    scenario_index,storyline,store_t,
    Life,
    reuse_rate,recRate,burRate,
    filepath
):
    ##############################################################################
    ...
    for i in range(0,1000):
        ...
        random.seed(a=i);coefC35_random.append(random.uniform(a = 6, b = 1.5))
    ...
    for i in range(0,1000):
        random.seed(a=i);C15percentage_random.append(random.weibullvariate(alpha = 0.749, beta = 14.8)*
        random.weibullvariate(alpha = 0.055, beta = 12))
        random.seed(a=i);C16percentage_random.append(random.weibullvariate(alpha = 0.749, beta = 14.8)*
        random.weibullvariate(alpha = 0.407, beta = 12))
        random.seed(a=i);C23percentage_random.append(random.weibullvariate(alpha = 0.749, beta = 14.8)*
        random.weibullvariate(alpha = 0.468, beta = 16))
        random.seed(a=i);C35percentage_random.append(random.weibullvariate(alpha = 0.749, beta = 14.8)*
        random.weibullvariate(alpha = 0.109, beta = 12))
    ...
    for i in range(0,1000):
        random.seed(a=i);RENpercentage_random.append((1-random.weibullvariate(alpha = 0.749, beta = 14.8))*
        random.weibullvariate(alpha = 0.524, beta = 14))
        random.seed(a=i);MASpercentage_random.append((1-random.weibullvariate(alpha = 0.749, beta = 14.8))*
        random.weibullvariate(alpha = 0.188, beta = 12))
        random.seed(a=i);MAIpercentage_random.append((1-random.weibullvariate(alpha = 0.749, beta = 14.8))*
    ...
    for i in range(0,1000):
        ...
        random.seed(a=i);radiusBur_random.append((
            ...
            random.uniform(a = 0.353, b= 0.513)*10+random.uniform(a = 0.107, b= 0.26)*20.75)*0.24+

            (random.uniform(a = 0.122, b= 0.256)*5+random.uniform(a = 0.195, b= 0.354)*10+
            random.uniform(a = 0.106, b= 0.225)*20+random.uniform(a = 0.248, b= 0.484)*25)*0.75+
        ...
        random.seed(a=i);radiusBurB_random.append((
            ...
            random.uniform(a = 0.107, b= 0.26)*26.5)*0.24+
    ...
    for i in range(0,1000):
        ...
        random.seed(a=i);CONpercentage_random.append(random.weibullvariate(alpha = 0.749, beta = 14.8))
